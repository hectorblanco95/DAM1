	...
	public static void main(String[] args) {
		...
		try{
			...
			while(v !=8){
				...
				case 1:
					System.out.println("Introduce el nombre del superh�roe: ");
					nom.add(i, buffer.readLine().toLowerCase());
					while (!nom.get(i).equals("capit�n am�rica") && !nom.get(i).equals("capitan am�rica") && !nom.get(i).equals("capit�n america") && !nom.get(i).equals("capitan america") && !nom.get(i).equals("iron man") && !nom.get(i).equals("thor") && !nom.get(i).equals("hulk") && !nom.get(i).equals("avispa") && !nom.get(i).equals("ojo de halc�n") && !nom.get(i).equals("ojo de halcon") && !nom.get(i).equals("henry pym") && !nom.get(i).equals("pantera negra") && !nom.get(i).equals("viuda negra")){
						System.out.println("Nombre incorrecto!");
						System.out.println("Introduce el nombre del superh�roe: ");
						nom.set(i, buffer.readLine().toLowerCase());
					}
					if (nom.get(i).equals("capit�n am�rica") || nom.get(i).equals("capitan am�rica") || nom.get(i).equals("capit�n america") || nom.get(i).equals("capitan america")){
						cont++;
						if (cont>=2){
							while (!nom.get(i).equals("capit�n am�rica") && !nom.get(i).equals("capitan am�rica") && !nom.get(i).equals("capit�n america") && !nom.get(i).equals("capitan america") && !nom.get(i).equals("iron man") && !nom.get(i).equals("thor") && !nom.get(i).equals("hulk") && !nom.get(i).equals("avispa") && !nom.get(i).equals("ojo de halc�n") && !nom.get(i).equals("ojo de halcon") && !nom.get(i).equals("henry pym") && !nom.get(i).equals("pantera negra") && !nom.get(i).equals("viuda negra")){
								System.out.println("Nombre incorrecto!");
								System.out.println("Introduce el nombre del superh�roe: ");
								nom.set(i, buffer.readLine().toLowerCase());
							} while (nom.get(i).equals("capit�n am�rica") || nom.get(i).equals("capitan am�rica") || nom.get(i).equals("capit�n america") || nom.get(i).equals("capitan america")){
								System.out.println("Nombre incorrecto!");
					...
					} if (nom.get(i).equals("ojo de halc�n") || nom.get(i).equals("ojo de halcon")){
						cont6++;
						if (cont6>=2){
							while (!nom.get(i).equals("capit�n am�rica") && !nom.get(i).equals("capitan am�rica") && !nom.get(i).equals("capit�n america") && !nom.get(i).equals("capitan america") && !nom.get(i).equals("iron man") && !nom.get(i).equals("thor") && !nom.get(i).equals("hulk") && !nom.get(i).equals("avispa") && !nom.get(i).equals("ojo de halc�n") && !nom.get(i).equals("ojo de halcon") && !nom.get(i).equals("henry pym") && !nom.get(i).equals("pantera negra") && !nom.get(i).equals("viuda negra")){
								System.out.println("Nombre incorrecto!");
								System.out.println("Introduce el nombre del superh�roe: ");
								nom.set(i, buffer.readLine().toLowerCase());
							} while (nom.get(i).equals("ojo de halc�n") || nom.get(i).equals("ojo de halcon")){
								System.out.println("Nombre incorrecto!");
								System.out.println("Introduce el nombre del superhéroe: ");
								nom.set(i, buffer.readLine().toLowerCase());
							}
					...
					System.out.println("Introduce nivel de superh�roe: ");
				...
				default:
					System.out.println("Opci�n no v�lida, introduce una opci�n correcta!");
					System.out.println();
					break;
				}
			}
