                                  ...
                                  <div class="inbox-body">
                                     <div class="mail-option">
                                         ...
                                         <ul class="unstyled inbox-pagination">
                                             ...
                                             if ($contador > 0) {
                                                 echo "<li>
                                                         <a class='np-btn' href='sentEmail_admin.php?contador=".($contador-10)."'><i class='fa fa-angle-left  pagination-left'></i></a>
                                                       </li>";
                                             }
                                             // Mostrar el siguiente (en cado de que lo haya)
                                             if (($contador + 10) < $total) {
                                                 echo "<li>
                                                         <a class='np-btn' href='sentEmail_admin.php?contador=".($contador+10)."'><i class='fa fa-angle-right pagination-right'></i></a>
                                                       </li>";
                                             }
                                             ?>
                                         </ul>
