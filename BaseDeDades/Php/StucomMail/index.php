...
<html>
    ...
    <body>
    	<header><img src="img/StucomMail.png"/ style="margin-top: -4px;width: 459px;"></header>
				...
				<div class="panel panel-login">
					...
					<div class="panel-body">
                		...
                		<form id="register-form" action="login.php" method="post" role="form" style="display: none;">
									...
									<div class="form-group">
										<input type="text" name="surname" id="surname" class="form-control" placeholder="Surname" maxlength="60" required>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
