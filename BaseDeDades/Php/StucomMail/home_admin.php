                      ...
                      <div class="user-head">
                          ...
                          <div class="collapse" id="toggleDemo0" style="height: 0px;"><br><br>
                            <ul class="inbox-nav inbox-divider">
                              ...
                              <li><a href="#" data-toggle="modal" data-target="#usuario"><i class="fa fa-fw -square -circle fa-plus-square"></i> New User</a></li>
                              <li><a href="#" data-toggle="modal" data-target="#delete"><i class="fa fa-trash-o"></i> Delete User</a></li>
                              <li><a href="logout.php"><i class="fa fa-sign-out"></i> Logout</a></li>
                            </ul>
                          </div>
                      </div>
                      <div class="inbox-body">
                          <a href="#myModal" data-toggle="modal" title="New Email" class="btn btn-compose">New Email</a>
                          <!-- Modal -->
                            ...
                            <form class="form-horizontal" action="login.php" method="post" role="form">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input id="username" name="username" class="form-control" placeholder="Username" type="text" maxlength="10" required="">
                                        </div>
                                    </div>
                                    <!-- Password input-->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input id="confirm-password" name="confirm-password" type="password" placeholder="Confirm Password" class="form-control input-md" maxlength="200" required="">
                                        </div>
                                    </div>
                                    <!-- Name input-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input id="name" name="name" type="text" placeholder="Name" class="form-control input-md" maxlength="20" required="">
                                        </div>
                                    </div>
                                    <!-- surname input-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input id="surname" name="surname" type="text" placeholder="Surname" class="form-control input-md" maxlength="60" required="">
                                        </div>
                                    </div>
                                    <!-- Select Basic -->
                                    <div class="form-group">
