...
public class ex06 {
	...
	public static void main (String[] args){
		try{
			...
			System.out.println("Introduce el n�mero de comerciales con los que deseas trabajar:");
			int n=Integer.parseInt(buffer.readLine());
			System.out.println("Introduce el n�mero de productos con los que deseas trabajar:");
